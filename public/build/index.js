...
var app = (function () {
    ...
    const file$1 = "src/routes/new.svelte";
    ...
    const file$2 = "src/routes/slug.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = `Playing game ${window.location.pathname}`;
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*pathname*/ ctx[1] == "/") return 0;
    		if (/*pathname*/ ctx[1] == "/new") return 1;
    		return 2;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			p.textContent = "Joseki Party is for playing Go.";
    			add_location(h1, file$3, 10, 1, 215);
    			add_location(p, file$3, 21, 1, 348);
    			attr_dev(main, "class", "svelte-y2h5td");
    			add_location(main, file$3, 9, 0, 207);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Index: Routes, New, Slug, name, pathname });
